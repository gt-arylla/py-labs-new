...
def FF_icon():
    ...
    # start_dir = '/Volumes/Untitled/Programming/Python Programs/csvExports/180608 JL Exports/180606'
    # start_json_dir = '/Volumes/Untitled/Programming/Python Programs/jsonExports/Juby Lee'
    # outputfilename = 'TestOutput'
    # outputfile_loc = '/Users/gagandeepphull/Desktop/TestFolder'
    # outputfile_dir = '{}{}{}{}'.format(outputfile_loc, '/', outputfilename, '.xlsx')
    # point_count = 10
    ...
    for file in files:
        ...
        if (plot_data_switch):
            ...
            plt.savefig(outputfile_loc + os.path.splitext(filename[len(start_dir):])[0] + '.png')
            plt.clf()
            plt.cla()
            plt.close()
